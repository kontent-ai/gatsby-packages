  ...
  return (
    <RichTextElement
      ...
      resolveLink={(link, domNode) => {
        ...
        return <Link to={`/${link.type}/partner/${parentItemType}/${link.url_slug}`}>{domNode.children[0].data}</Link>;
      }}
          ...
          "images": [
            {
              ...
              "url": "https://assets-us-01.kc-usercontent.com:443/09fc0115-dd4d-00c7-5bd9-5f73836aee81/f5b597e3-ed16-48b6-9319-529db58dbded/clovek_1.jpg",
              "width": 1000
            }
          ],
          "links": [
